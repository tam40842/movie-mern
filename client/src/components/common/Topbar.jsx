                    ...
                    <Toolbar sx={{ alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <Box flexGrow={1} alignItems="center" display={{ xs: "none", md: "flex" }}>
                            ...
                            {menuConfigs.main.map((item, index) => (
                                <Button key={index} sx={{ color: appState.includes(item.state) ? "primary.contrastText" : "inherit", mr: 2 }} component={Link} to={item.path} variant={appState.includes(item.state) ? "contained" : "text"} >
                                    {item.display}
                                </Button>
                            ))}
                            <IconButton
